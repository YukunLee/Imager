...
open class ImagerTransition: UIPercentDrivenInteractiveTransition {
    ...
    weak var imagerController: ImagerController?
    
    // MARK: - Transition
    
    func transition(_ show: Bool) {
        guard let controller = imagerController else { return }
    ...
    func handlePanGesture(_ gesture: UIPanGestureRecognizer) {
        ...
        case .began:
            interactive = true
            imagerController?.presented = false
            imagerController?.dismiss(animated: true, completion: nil)
        ...
        case .ended, .cancelled:
            ...
            interactive = false
            imagerController?.presented = true
    ...
    override open func finish() {
        ...
        guard let imagerController = imagerController else { return }
        imagerController.delegate?.imagerControllerWillDismiss(imagerController)
    }
}

// MARK: - UIViewControllerAnimatedTransitioning

extension ImagerTransition: UIViewControllerAnimatedTransitioning {
...
extension ImagerTransition: UIViewControllerTransitioningDelegate {
...
extension ImagerTransition: UIGestureRecognizerDelegate {
