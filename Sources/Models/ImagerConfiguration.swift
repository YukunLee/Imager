...
open class ImagerConfiguration {
    
    public enum ButtonKey: String {
        case close = "Close"
        case delete = "Delete"
        case more = "More"
    ...
    open static var loadImage: (_ imageView: UIImageView, _ URL: URL, _ completion: LoadImageCompletion?) -> Void = {
        ...
        NSURLConnection.sendAsynchronousRequest(imageRequest, queue: OperationQueue.main, completionHandler: { response, data, error in
    ...
    public struct CloseButton {
        ...
        public static var text = ImagerConfiguration.ButtonKey.close.localizedString
    ...
    public struct DeleteButton {
        ...
        public static var text = ImagerConfiguration.ButtonKey.delete.localizedString
        public static var image: UIImage?
    ...
    public struct ImagerInfoLabel {
        public static var enabled = true
        public static var textColor = UIColor.white
        public static var ellipsisText = ImagerConfiguration.ButtonKey.more.localizedString
    ...
    public struct ImagerLoadingIndicator {
